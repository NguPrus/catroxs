...
switch ($mod) {
    case 'optim':
		echo '<div class="phdr"><a href="index.php?act=info"><b>Informasi</b></a> | Table Optimasi MySQl</div>';
		...
		echo '<div class="bmenu">Total (terfragmentasi)&#160;<b>'.formatsize($sbd).'</b></div>'.
    ...
    default:
		...
		$de_functions = (strlen(ini_get('disable_functions')) > 1) ? ini_get('disable_functions') : '<font color="#990000"><b>Нет.</b></font>';
	...
	echo '<p><h3><img src="../images/system/9.png" width="16" height="16" class="left" alt="" />&#160;Informasi</h3>'.
